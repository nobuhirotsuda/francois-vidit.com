...
!!! 1736年の9月26日、[ヴェルサイユ宮殿][4]で、[{r=ja/fr}ルイ(Louis)15(XV){/r}世][1]により、新たに改装された{r=ja/fr}ヘラクレスの間(Salon&#160;d&#39;Hercule){/r}のために作られた、この画家の{r=ja/fr}フランソワ(François)・()ルモワーヌ(Lemoyne){/r}の作品《{r=ja/fr}ヘラクレスの神格化(Apothéose&#160;d&#39;Hercule){/r}》が除幕されました。  
...
!!! 以下の文書はこのテキストです。  
!!! この画家の作品は、多くの理由で特別であり、特に彼の最後の作品は特別です。  
